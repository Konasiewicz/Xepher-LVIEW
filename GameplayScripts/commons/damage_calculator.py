...
class DamageSpecification:
    ...
    def calculate_damage(self, game, source, target):
...
def get_damage_specification(game, champ) -> Optional[DamageSpecification]:
    ...
    if champ.name == "darius":
        ...
        if IsReady(game, champ.Q):
            if champ.Q.level == 1:
                spec.base_damage = 75.0
            elif champ.Q.level == 2:
                spec.base_damage = 105.0
            elif champ.Q.level == 3:
                spec.base_damage = 135.0
            elif champ.Q.level == 4:
                spec.base_damage = 165.0
            elif champ.Q.level == 5:
                spec.base_damage = 195.0

        if IsReady(game, champ.E):
            if champ.Q.level == 1:
                spec.base_damage = 15.0
            elif champ.Q.level == 2:
                spec.base_damage = 30.0
            elif champ.Q.level == 3:
                spec.base_damage = 45.0
            elif champ.Q.level == 4:
